...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_HNGJF_LIST:
    case types.API_V1_HNGJF_LIST_SUCCEEDED:
    case types.API_V1_HNGJF_LIST_FAILED:
      return Object.assign({}, state, {
        moctAPI: [...state.moctAPI, action.response]
      })
    case types.API_V1_HNGJF_CREATE:
    case types.API_V1_HNGJF_CREATE_SUCCEEDED:
    case types.API_V1_HNGJF_CREATE_FAILED:
      return Object.assign({}, state, {
        moctAPI: [...state.moctAPI, action.response]
      })
    case types.API_V1_HNGJF_READ:
    case types.API_V1_HNGJF_READ_SUCCEEDED:
    case types.API_V1_HNGJF_READ_FAILED:
      return Object.assign({}, state, {
        moctAPI: [...state.moctAPI, action.response]
      })
    case types.API_V1_HNGJF_UPDATE:
    case types.API_V1_HNGJF_UPDATE_SUCCEEDED:
    case types.API_V1_HNGJF_UPDATE_FAILED:
      return Object.assign({}, state, {
        moctAPI: [...state.moctAPI, action.response]
      })
    case types.API_V1_HNGJF_PARTIAL_UPDATE:
    case types.API_V1_HNGJF_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_HNGJF_PARTIAL_UPDATE_FAILED:
      return Object.assign({}, state, {
        moctAPI: [...state.moctAPI, action.response]
      })
    case types.API_V1_HNGJF_DELETE:
    case types.API_V1_HNGJF_DELETE_SUCCEEDED:
    case types.API_V1_HNGJF_DELETE_FAILED:
      return Object.assign({}, state, {
        moctAPI: [...state.moctAPI, action.response]
      })
